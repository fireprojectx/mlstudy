function criarBarra(var_nome, var_avatar) {
  ...
  // Nome do usuário e ícone de verificação
  ...
  // Inserção da barra de usuário na interface
  if (elementoPai) {
    elementoPai.prepend(userBar);
  }

  // Configuração de notificação de áudio e monitoramento de status
